  ...
  <v-app>
    <v-main>
      <v-container>
        ...
        <v-footer absolute app class="bg-primary text-white pt-6">
          <v-container>
            <v-row>
              <v-col cols="12" md="4" class="mb-6 mb-md-0">
                <h3 class="text-h6 text-white font-weight-bold mb-4">digiSarathi</h3>
                <p class="text-body-2">Tech4Growth, Tech4Good!</p>
              </v-col>

              <v-col cols="6" md="4" class="mb-6 mb-md-0">
                <h4 class="text-h6 text-white font-weight-bold mb-4">Services</h4>
              ...
              <v-col cols="12" md="4">
                <h4 class="text-h6 text-white font-weight-bold mb-4">Contact</h4>
                ...
                <div class="d-flex align-center mb-2">
                  ...
                  <a href="mailto:hello@digisarathi.com"
                    class="text-decoration-none text-body-2 text-white">hello@digisarathi.com</a>
                </div>
                ...
                <div class="d-flex">
                  ...
                  <a href="https://www.linkedin.com/company/digisarathi-it-solutions-pvt-ltd/" target="_blank"
