<template>
  ...
  >
    <p>In a significant initiative to address the pressing issue of Child Sexual Abuse in India, Prerana, Mumbai, in collaboration with the ADM Foundation, launched 'Aarambh India.' Recognizing the need for heightened awareness and best practices, the team aimed to leverage digital platforms to engage with the numerous nonprofits dedicated to child welfare across the country.</p>
    ...
    <ul>
      <li><strong>Stakeholder Engagement:</strong> Identifying the different stakeholders and their specific requirements to ensure the portal would serve a wide audience.</li>
      <li><strong>Content Strategy:</strong> Curating various content types to address the needs of different users, including awareness campaigns, educational resources, and video snippets.</li>
      <li><strong>Design and Testing:</strong> Creating multiple design options that were rigorously evaluated for usability and aesthetic appeal. The code was tested across various devices to ensure a seamless user experience.</li>
    </ul>
