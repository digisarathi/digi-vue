<template>
  <PostLayout :post="post">
    ...
    <p>
      A website is essentially 4/5 pages that talks about any organization and its programs. Then I remembered how one of our clients, <a href="https://thoughtshopfoundation.org/" target="_blank" rel="noopener noreferrer">ThoughtShop Foundation</a>, in Kolkatta, have a non-WordPress website. Whenever needed, they make some 'content' updates in the Team or Donor section. Without WordPress, there is no 'software' updates or the bare minimum. But with WordPress, the software updates is as frequent as the 'apps' on our phone, i.e. forever &amp; ever! Which means the cost of AMC that digiSarathi or other IT vendors charge their clients is not coming down. This didn't feel right!
    </p>
...
const post = {
  ...
  tags: ['Industry', 'Nonprofits (NGOs)', 'SMEs', 'Socent', 'Website Design', 'SEO'],
  excerpt:
    'After 11 years of WordPress overhead, we explored simpler alternatives. Discover how modern static sites can eliminate maintenance costs while keeping blogging capabilities.',
}
