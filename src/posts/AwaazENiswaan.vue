<template>
  <PostLayout :post="post">
    ...
    <p>
      <em>Our (Aawaaz-e-Niswaan)'s website was designed and completed by digiSarathi and has been receiving applauds from different people. It is so eye-appealing and professionally done that it looks great. It works well on mobile devices, we have tried it on android and iPhones and it worked great on both. We love how easy it is to navigate through the pages and digiSarthi is available in a blink of an eye to provide any required support when / if we need it.</em>
    </p>
  </PostLayout>
</template>
...
const post = {
  ...
  tags: ['Nonprofits (NGOs)', 'Consulting', 'SEO', 'Women Safety', 'Website Design'],
  excerpt:
    'Website overhaul for Awaaz-e-Niswaan, working with Muslim women and girls on safety, justice, education and livelihood. Features integrated Instagram feed for regular updates.',
}
