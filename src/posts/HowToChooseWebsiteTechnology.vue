<template>
  <PostLayout :post="post">
    ...
    <p>#NonprofitTech #SMEStrategy #WebPerformance #UXDesign</p>

    <h3>Experience Unmatched Performance</h3>
    <p>
    ...
    <h3>To schedule a 1-on-1 consultation, <a href="mailto:hello@digisarathi.com">Email us!</a></h3>

    <h3>What to Expect</h3>
    <ul>
      <li><strong>In-Depth Analysis:</strong> We'll review your existing website and digital strategies.</li>
      <li><strong>Customized Recommendations:</strong> Receive Project Plan with actionable insights on enhancing your online presence.</li>
      <li><strong>Future-Proof Strategies:</strong> Explore innovative solutions to stay ahead in the digital landscape.</li>
    </ul>

    <h3>Take the First Step</h3>
    <p>Let's work together to make 2025 your best year yet!</p>
  </PostLayout>
</template>
...
const post = {
  ...
  tags: ['Industry', 'Nonprofits (NGOs)', 'SMEs', 'Website Design'],
  excerpt:
    'With attention spans on the internet at their lowest, page load times and device/screen size responsiveness can make or break the user experience (UX).',
}
